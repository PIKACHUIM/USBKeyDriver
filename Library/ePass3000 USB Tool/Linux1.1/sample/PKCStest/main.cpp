...
CK_RV BaseAllStart()
{
	...
	CK_RV rv = CKR_OK;
	m_hSo = dlopen("libepsng_p11.so",RTLD_NOW);
	if(m_hSo == NULL)
	{
		cout << "......LoadLibrary [" << "libepsng_p11.so"<< "] failed!" << endl;
...
int main(int argc, char* argv[])
{
	...
	if(argv[1] == NULL)
	{
		cout<<"1: DES, 2: DES3, 3: RC2, 4:RC4, 5:RSA, 6: SSF33"<<endl;
		//cout<<"1: DES, 2: DES3, 3: RC2, 4:RC4, 5:RSA, 6: DSA, 7: DH"<<endl;
		cout<< "0: Exit."<<endl;
