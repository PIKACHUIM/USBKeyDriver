...
DESC:
	Implementation of Class CGetInfos.
[]=========================================================================[]
*/
...
//////////////////////////////////////////////////////////////////////
#define  DEBUG_PATH_1000		"ep1kpk111.dll"
#define  DEBUG_PATH_2000		"ep2pk11.dll"
#define  DEBUG_PATH_NG_WIN32	"ngp11v211.dll"
#define  DEBUG_PATH_NG_MAC		"libepsng_p11.dylib"
#define  DEBUG_PATH_NG_LINUX	"libepsng_p11.so"

//Initialize the token Cryptoki library:
CGetInfos::CGetInfos(int iOption):m_hDll(NULL_PTR)
{
	if(iOption == 1)	//test ePass1000.
	{
		#ifdef _DEBUG
			m_path = DEBUG_PATH_1000;
		#else
			m_path = "ep1pk111.dll";
		#endif
	}
...
#if defined(WIN32)
		#ifdef _DEBUG
			m_path = DEBUG_PATH_NG_WIN32;
		#else
			m_path = "ngp11v211.dll";
		#endif
#elif defined(linux)
		m_path = DEBUG_PATH_NG_LINUX;
#elif defined(macintosh)
		m_path = DEBUG_PATH_NG_MAC;
#endif
	}
