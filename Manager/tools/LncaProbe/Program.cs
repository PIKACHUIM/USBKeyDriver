...
class Program
{
    ...
    static int Main(string[] args)
    {
        ...
        string dllPath = args.Length > 0 ? args[0] : @"G:\Codes\USBKeyDriver\Library\LNCA USBKey Manage\JIT_USBKEY_HD.dll";
    ...
    {
        string dll = @"G:\Codes\USBKeyDriver\Library\LNCA USBKey Manage\JIT_USBKEY_HD.dll";
    ...
    {
        string dll = @"G:\Codes\USBKeyDriver\Library\LNCA USBKey Manage\HD_HardAPI.dll";
